...
async function fetchMangaNews() {
    try {
        ...
        const newsContainer = document.getElementById('mangaNews');

        if (!newsContainer) {
            console.error('Element with id "mangaNews" not found.');
            return;
        }
...
document.addEventListener('DOMContentLoaded', fetchMangaNews);